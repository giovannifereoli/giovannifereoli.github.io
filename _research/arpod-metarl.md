...
- Achieves robust, computation-efficient performance relative to optimal control baselines
...
- **MSc Defense Presentation**  
  [Read the presentation](https://www.researchgate.net/publication/376681432_MSc_Defense_Presentation) — *Completed*
- **Journal Paper**  
  [Read the paper](https://doi.org/10.2514/1.A36100) — *Published*
